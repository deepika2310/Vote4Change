...
function addcandidate()
{
    ...
    var data = new FormData(form); //for copy image to data variable
    alert(data);
    var cid=$("#cid").val();
    var cname=$("#cname").val();
    var city=$("#city").val();
    ...
    //here we can use JSON also to send data but JSON transfer data only in text format and here we have to convert image into into text format by using (Base64) library
    $.ajax({
            type: "POST",
